...
/***/ "./node_modules/css-loader/index.js?{\"modules\":true,\"localIdentName\":\"[name]-[local]__[hash:base64:4]\"}!./node_modules/postcss-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/styles/DataDetails.sass":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".DataDetails-main__2u5m {\n  margin: 16px 0px;\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  border: none;\n  padding: 0px; }\n  .DataDetails-main__2u5m table {\n    border-spacing: 0;\n    border-collapse: collapse;\n    width: 100%;\n    padding: 0px;\n    border: none;\n    table-layout: fixed; }\n    .DataDetails-main__2u5m table .DataDetails-group__1dQp {\n      display: table-row-group; }\n      .DataDetails-main__2u5m table .DataDetails-group__1dQp .DataDetails-title__2SmS {\n        font-size: 30px;\n        color: #32363F;\n        letter-spacing: 1.25px;\n        line-height: 40px; }\n      .DataDetails-main__2u5m table .DataDetails-group__1dQp td, .DataDetails-main__2u5m table .DataDetails-group__1dQp th {\n        border: none;\n        padding: 16px;\n        text-align: left; }\n        .DataDetails-main__2u5m table .DataDetails-group__1dQp td h2, .DataDetails-main__2u5m table .DataDetails-group__1dQp th h2 {\n          margin: 0px;\n          padding: 0px;\n          font-size: 30px;\n          color: #32363F;\n          letter-spacing: 1.25px;\n          line-height: 40px; }\n    .DataDetails-main__2u5m table .DataDetails-item__3uoA td, .DataDetails-main__2u5m table .DataDetails-item__3uoA th {\n      border: 1px solid #AAA;\n      padding: 16px;\n      text-align: left; }\n    .DataDetails-main__2u5m table .DataDetails-item__3uoA th {\n      font-size: 14px;\n      color: #32363F;\n      letter-spacing: 1.17px;\n      background-color: #F6F6F6;\n      font-weight: lighter;\n      width: 320px; }\n    .DataDetails-main__2u5m table .DataDetails-item__3uoA td {\n      font-size: 14px;\n      color: #32363F;\n      letter-spacing: 1.17px;\n      font-weight: 300; }\n      .DataDetails-main__2u5m table .DataDetails-item__3uoA td input, .DataDetails-main__2u5m table .DataDetails-item__3uoA td select {\n        -webkit-appearance: none;\n           -moz-appearance: none;\n                appearance: none;\n        background: #FFFFFF;\n        border: 1px solid #9B9B9B;\n        border-radius: 2px;\n        padding: 10px 16px; }\n        .DataDetails-main__2u5m table .DataDetails-item__3uoA td input[type=\"text\"], .DataDetails-main__2u5m table .DataDetails-item__3uoA td input[type=\"number\"], .DataDetails-main__2u5m table .DataDetails-item__3uoA td select[type=\"text\"], .DataDetails-main__2u5m table .DataDetails-item__3uoA td select[type=\"number\"] {\n          display: block;\n          width: calc(100% - 32px); }\n", ""]);

// exports
exports.locals = {
	"main": "DataDetails-main__2u5m",
	"group": "DataDetails-group__1dQp",
	"title": "DataDetails-title__2SmS",
	"item": "DataDetails-item__3uoA"
};
...
var _DataDetails = __webpack_require__("./src/components/elements/DataDetails.jsx");
...
var Data = function (_Component) {
    ...
    _createClass(Data, [{
        ...
        value: function renderData(doctype) {
            ...
            return _react2.default.createElement(
                _DataDetails2.default,
                null,
                fields.map(function (group, keygroup) {
                    return _react2.default.createElement(
                        _DataDetails2.default.Group,
                        { title: group.name, key: keygroup },
                        _.flatMap(group.group, function (item, key) {
                            if (item.type === 'contract') {
                                if (!current[item.name]) current[item.name] = {};
                                return [_react2.default.createElement(_DataDetails2.default.Item, {
                                    key: key + 0.1,
                                    title: "Société",
                                    value: current[item.name].company,
                                    type: "text",
                                    updatable: _this3.state.edition,
                                    onChange: function onChange(e) {
                                        return current[item.name].company = e;
                                    }
                                }), _react2.default.createElement(_DataDetails2.default.Item, {
                                    key: key + 0.2,
                                    title: "Adresse",
                                    value: current[item.name].address,
                                    type: "text",
                                    updatable: _this3.state.edition,
                                    onChange: function onChange(e) {
                                        return current[item.name].address = e;
                                    }
                                }), _react2.default.createElement(_DataDetails2.default.Item, {
                                    key: key + 0.3,
                                    title: "Email",
                                    value: current[item.name].email,
                                    type: "email",
                                    updatable: _this3.state.edition,
                                    onChange: function onChange(e) {
                                        return current[item.name].email = e;
                                    }
                                }), _react2.default.createElement(_DataDetails2.default.Item, {
                                    key: key + 0.4,
                                    title: "Téléphone",
                                    value: current[item.name].telephone,
                                    type: "telephone",
                                    updatable: _this3.state.edition,
                                    onChange: function onChange(e) {
                                        return current[item.name].telephone = e;
                                    }
                                })];
                                ...
                                return [_react2.default.createElement(_DataDetails2.default.Item, {
                                    key: key + 0.1,
                                    title: "Adresse",
                                    value: current[item.name].way,
                                    type: "text",
                                    updatable: _this3.state.edition,
                                    onChange: function onChange(e) {
                                        return current[item.name].way = e;
                                    }
                                }), _react2.default.createElement(_DataDetails2.default.Item, {
                                    key: key + 0.2,
                                    title: "Code postal",
                                    value: current[item.name].postalCode,
                                    type: "text",
                                    updatable: _this3.state.edition,
                                    onChange: function onChange(e) {
                                        return current[item.name].postalCode = e;
                                    }
                                }), _react2.default.createElement(_DataDetails2.default.Item, {
                                    key: key + 0.3,
                                    title: "Ville",
                                    value: current[item.name].city,
                                    type: "text",
                                    updatable: _this3.state.edition,
                                    onChange: function onChange(e) {
                                        return current[item.name].city = e;
                                    }
                                })];
...
/***/ "./src/components/elements/DataDetails.jsx":
/***/ (function(module, exports, __webpack_require__) {
...
exports.DataDetails = exports.DataDetailsItem = exports.DataDetailsGroup = undefined;
...
var _DataDetails = __webpack_require__("./src/styles/DataDetails.sass");
...
var DataDetailsGroup = exports.DataDetailsGroup = function DataDetailsGroup(props) {
    return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(
        ...
        _react2.default.createElement(
            'table',
            { className: _DataDetails2.default.group },
            _react2.default.createElement(
                'tbody',
                null,
                props.children
...
var DataDetailsItem = exports.DataDetailsItem = function (_Component) {
    _inherits(DataDetailsItem, _Component);

    function DataDetailsItem(props, context) {
        _classCallCheck(this, DataDetailsItem);

        var _this = _possibleConstructorReturn(this, (DataDetailsItem.__proto__ || Object.getPrototypeOf(DataDetailsItem)).call(this, props, context));
    ...
    _createClass(DataDetailsItem, [{
        key: '_onChangePhone',
        value: function _onChangePhone(val) {
            // check if is a phone number
            var checkPhone = /0\d?([. -]?\d\d){0,4}\d?/;

            if (checkPhone.test(val)) this._onChange(val);
        }
    }, {
        key: '_onChange',
        ...
        value: function renderValue() {
            ...
            // console.log("Value", value, type, this.props.title)
            ...
            if (!this.props.updatable) {
                ...
                if (_lodash2.default.isObject(value)) value = "";
                return value;
            } else {
                switch (type) {
                    case 'boolean':
                    ...
                    case 'list':
                        if (!value) {
                            if (_lodash2.default.isFunction(this.props.onChange)) this.props.onChange(this.props.values && this.props.values[0]);
                        }
                        return _react2.default.createElement(
                            'select',
                            { value: value, onChange: function onChange(e) {
                    ...
                    case 'date':
                        if (!value) {
                            ...
                            if (_lodash2.default.isFunction(this.props.onChange)) this.props.onChange(value.format('DD/MM/YYYY'));
                        } else {
                            value = (0, _moment2.default)(value, 'DD/MM/YYYY');
                        }
                        // console.log("Render date picker", value)
                    ...
                    case 'email':
                        return _react2.default.createElement('input', { type: 'email', value: value, onChange: function onChange(e) {
                                return _this2._onChange(e.target.value);
                            }, placeholder: this.props.title });

                    case 'telephone':
                        return _react2.default.createElement('input', { type: 'text', value: value, onChange: function onChange(e) {
                                return _this2._onChangePhone(e.target.value);
                            }, placeholder: this.props.title });

                    case 'textarea':
                        return _react2.default.createElement('textarea', { value: value, onChange: function onChange(e) {
                                return _this2._onChange(e.target.value);
                            }, placeholder: this.props.title });

                    default:
                        return _react2.default.createElement('input', { type: type, value: value, placeholder: this.props.title, onChange: function onChange(e) {
                                return _this2._onChange(e.target.value);
                            } });
        ...
        value: function render() {
            return _react2.default.createElement(
                'tr',
                { className: _DataDetails2.default.item },
                _react2.default.createElement(
                    'th',
                    null,
                    _react2.default.createElement(
    ...
    return DataDetailsItem;
}(_react.Component);

var DataDetails = exports.DataDetails = function DataDetails(props) {
    return _react2.default.createElement(
        'form',
        { className: _DataDetails2.default.main, onSubmit: function onSubmit() {
...
DataDetails.Item = DataDetailsItem;
DataDetails.Group = DataDetailsGroup;

exports.default = DataDetails;
...
var Documents = exports.Documents = function (_Component) {
    ...
    _createClass(Documents, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                _Page2.default,
                { title: title, subtitle: !loading && status != _constants.STATUS_ERROR && lastType === _constants.TYPE_FOLDER && count + " élément" + (count > 1 ? "s" : ""),
                    actions: actions,
...
/***/ "./src/styles/DataDetails.sass":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js?{\"modules\":true,\"localIdentName\":\"[name]-[local]__[hash:base64:4]\"}!./node_modules/postcss-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/styles/DataDetails.sass");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--3-2!../../node_modules/postcss-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./DataDetails.sass", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--3-2!../../node_modules/postcss-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./DataDetails.sass");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
