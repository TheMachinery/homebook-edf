                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 4:
                            ...
                            return _context2.abrupt("return", dispatch({ type: DATA_NEW_SUCCESS, data: newData, doctype: doctype }));

                        case 8:
                            _context2.prev = 8;
                            _context2.t0 = _context2["catch"](1);
                            return _context2.abrupt("return", dispatch({ type: DATA_NEW_FAILURE, err: _context2.t0 }));
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 4:
                            ...
                            return _context3.abrupt("return", dispatch({ type: DATA_SAVE_SUCCESS, data: newData, doctype: doctype }));

                        case 8:
                            _context3.prev = 8;
                            _context3.t0 = _context3["catch"](1);
                            return _context3.abrupt("return", dispatch({ type: DATA_SAVE_FAILURE, err: _context3.t0 }));
...
var documentsInitialize = exports.documentsInitialize = function documentsInitialize(name) {
    return function () {
        var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(dispatch, getState) {
            ...
            }, _callee5, undefined, [[1, 35], [8, 20, 24, 32], [25,, 27, 31]]);
        }));
...
var Documents = exports.Documents = function (_Component) {
    ...
    _createClass(Documents, [{
        ...
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(newProps) {
            var param = newProps.match.params.path;
            var newPath = _constants.ROOT_PATH;
            if (param) newPath += '/' + param;
        ...
        value: function render() {
            ...
            var loading = status !== _constants.STATUS_DONE || !files;
            ...
            var parentPath = folder && (0, _tools.findParentPath)(folder.path);
            ...
            return _react2.default.createElement(
                _Page2.default,
                { title: title, subtitle: fileCount !== null && status != _constants.STATUS_ERROR && fileCount + " élément" + (fileCount > 1 ? "s" : ""),
                    actions: actions,
                    onBackPress: parentPath && function () {
                        return _this2.props.history.goBack();
                    },
                    options: [filter] },
                _react2.default.createElement(_Loader2.default, { display: loading }),
                !loading && this.props.lastType === _constants.TYPE_FOLDER && files.length > 0 && _react2.default.createElement(
                    _DocumentList2.default,
                    {
                        ...
                        onClickItem: function onClickItem(item) {
                            ...
                            if ((0, _tools.isDirectory)(item)) {
                                _this2.props.onFileClick(null);
                                path = (0, _tools.createFakePath)(item.path);
                            } else {
                                //check for simple file
                                _this2.props.onFileClick(item);
                                path = (0, _tools.createFakePath)(_this2.props.folder.path + '/' + item.name);
                            }
                ...
                !loading && this.props.lastType === _constants.TYPE_FILE && _react2.default.createElement(_DocumentView2.default, { file: current }),
                !loading && files.length === 0 && "Dossier vide",
                _react2.default.createElement(
                    _reactPortal2.default,
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    console.log('Current Version:', '2.0.20');
...
exports.doctype = exports.data = undefined;
...
var data = exports.data = function data() {
    ...
    switch (action.type) {
        case _actions.LOAD_DATA_SUCCESS:
            ...
            // case LOAD_EQUIPMENTS_SUCCESS:
            // case LOAD_MAINTENANCES_SUCCESS:
            // case LOAD_DIAGNOSIS_SUCCESS:
            return action.data;
...
var doctype = exports.doctype = function doctype() {
    ...
    switch (action.type) {
        ...
        // case LOAD_DIAGNOSIS_SUCCESS:
        //     return DOCTYPE_DIAGNOSIS
        // case LOAD_WORKS_SUCCESS:
        //     return DOCTYPE_WORKS
        // case LOAD_MAINTENANCES_SUCCESS:
        //     return DOCTYPE_MAINTENANCES
        // case LOAD_HOME_SUCCESS:
        //     return DOCTYPE_HOMEDATA
        // case LOAD_EQUIPMENTS_SUCCESS:
        //     return DOCTYPE_EQUIPMENTS
        default:
            return state;
    }
};
