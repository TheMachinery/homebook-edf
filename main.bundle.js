...
var documentsMove = exports.documentsMove = function documentsMove(files, path) {
    return function () {
        var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(dispatch) {
            ...
            }, _callee9, undefined, [[2, 40], [9, 25, 29, 37], [30,, 32, 36]]);
        }));
...
var importerFilesUpload = exports.importerFilesUpload = function importerFilesUpload(files, dirId) {
    return function () {
        var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(dispatch, getState) {
            var newFiles, conflits, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, data, file;
                    ...
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 48:
                            return _context3.abrupt('return', dispatch({
                                ...
                                currentDir: getState().documents.folder.id === dirId,
                                conflits: conflits
                            }));
            ...
            }, _callee3, undefined, [[3, 51], [7, 36, 40, 48], [12, 23], [41,, 43, 47]]);
        }));
...
var Assistant = exports.Assistant = function Assistant(props) {
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { replace: true, to: "/assistant/diagnosis" },
                    'Cr\xE9er une donn\xE9e de diagnostic'
                )
            ),
            _react2.default.createElement(
                'li',
                ...
                _react2.default.createElement(
                    _reactRouterDom.Link,
                    { replace: true, to: "/assistant/homedata" },
                    'Cr\xE9er une donn\xE9e de maison'
                )
            ),
            _react2.default.createElement(
                'li',
                ...
                _react2.default.createElement(
                    _reactRouterDom.Link,
                    { replace: true, to: "/assistant/equipments" },
                    'Cr\xE9er une donn\xE9e d\'\xE9quipement'
                )
            ),
            _react2.default.createElement(
                'li',
                ...
                _react2.default.createElement(
                    _reactRouterDom.Link,
                    { replace: true, to: "/assistant/works" },
                    'Cr\xE9er une donn\xE9e de travaux'
                )
            ),
            _react2.default.createElement(
                'li',
                ...
                _react2.default.createElement(
                    _reactRouterDom.Link,
                    { replace: true, to: "/assistant/maintenances" },
                    'Cr\xE9er une donn\xE9e d\'entretien'
                )
            )
        )
    );
    ...
    _createClass(Contacts, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                !loading && elements.length > 0 && (0, _map3.default)(sortedContacts, function (peoples, letter) {
                    return _react2.default.createElement(
                        'div',
                        { key: letter },
                        _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ActiveLink,
                        { to: '/actualites', onClick: function onClick() {
                                return console.log('Open actualites');
                            }, activeClassName: _Navigation2.default.active },
                        'Actualit\xE9s'
                    )
                ),
...
var exportHomebook = function exportHomebook() {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { className: _Modal2.default.popup, onClick: function onClick(e) {
                        ...
                        return _this3.stopClosing(e);
                    }, onMouseLeave: function onMouseLeave(e) {
                        return _this3.startClosing(e);
                    } },
                _react2.default.createElement(
                    'div',
    ...
    _createClass(CustomInput, [{
        ...
        value: function render() {
            ...
            switch (type) {
                ...
                case 'list':
                    // if(!value) {
                    //     this.props.onChange(this.props.values && this.props.values[0])
                    // }
                    return _react2.default.createElement(
                        'select',
                        { autoFocus: this.props.autoFocus, className: this.props.className, style: this.props.style, value: value, onChange: function onChange(e) {
                ...
                case 'address':
                    ...
                    return _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement('input', { type: 'text', autoFocus: this.props.autoFocus, className: this.props.className, style: this.props.style, value: value.line, onChange: function onChange(e) {
                                return _this2.onChangeMulti(e.target.value, "line");
                            }, placeholder: "Voie" }),
                        _react2.default.createElement('input', { type: 'text', autoFocus: this.props.autoFocus, className: this.props.className, style: this.props.style, value: value.postalCode, onChange: function onChange(e) {
                                return _this2.onChangeMulti(e.target.value, "postalCode");
                            }, placeholder: "Code postal" }),
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    console.log('Current Version:', '2.1.136');
...
var autoImport = exports.autoImport = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
        var domain, slug, name, exist, tempDir, dir, job, newDir, dirContent, id, unzipedDir, filesContent, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, file, tag, path, parent;
        ...
        }, _callee, undefined, [[4, 10], [23, 28], [45, 79, 83, 91], [57, 63], [84,, 86, 90]]);
    }));
...
var getTagOf = function getTagOf(name) {
    ...
    try {
        for (var _iterator2 = _documents2.default[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var d = _step2.value;
...
var getPathOf = function getPathOf(tag) {
    ...
    try {
        for (var _iterator3 = fileTypes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            var t = _step3.value;
...
var saveActor = function () {
    var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(name) {
        var meta, indexRef, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, e;
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    ...
                    case 12:
                        ...
                        _iteratorError4 = undefined;
                        _context3.prev = 15;
                        _iterator4 = meta[Symbol.iterator]();
...
var InitKonnector = exports.InitKonnector = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
        var triggers, konnectorTrigger, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, t, data, trigger;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 15:
                        reellink = _context.sent;
                        return _context.abrupt('return', reellink);
...
exports.default = function () {
    ...
    (0, _AutoImport.autoImport)().then(function () {
        return console.log('Auto import OK');
    }).catch(function (err) {
