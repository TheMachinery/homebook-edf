...
var importerFilesUpload = exports.importerFilesUpload = function importerFilesUpload(files, dirId) {
    return function () {
        var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(dispatch, getState) {
            ...
            }, _callee3, undefined, [[2, 49], [6, 34, 38, 46], [11, 17], [39,, 41, 45]]);
        }));
        ...
        props.children.map(function (item, key) {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: _DocumentList2.default.content },
                    _react2.default.createElement(DocIcon, { doc: item })
                ),
                _react2.default.createElement(
                    'div',
                    {
...
var DocIcon = function (_Component) {
    ...
    _createClass(DocIcon, [{
        ...
        value: function getItemIcon() {
            ...
            var item = this.props.doc;
            var type = item.type || 'file';
            var icon = '/images/file';

            if (type === 'file') {
                if (item.class === 'image' && item.links && item.links.small) {
                    cozy.client.fullpath(item.links.small).then(function (path) {
                        return _this2.setState({ icon: path });
                    });
                }
            } else {
                icon = '/images/';
        ...
        value: function iconErr() {
            ...
            if (this.props.doc.class === 'image') {
                cozy.client.files.getDownloadLinkById(this.props.doc.id).then(function (link) {
...
var DocumentView = function (_Component) {
    ...
    _createClass(DocumentView, [{
        ...
        value: function renderImage() {
            ...
            return _react2.default.createElement(
                ...
                { ref: 'imagebox', style: { overflow: 'auto', flex: 1, display: 'inline-block' }, onTouchStart: function onTouchStart(e) {
                        ...
                        return _this4.handleTouchStop(e);
        ...
        value: function componentDidUpdate() {
            if (this.refs.imagebox && this.props.current.mime.indexOf(IMAGE) !== -1) {
        ...
        value: function render() {
            ...
            if (this.state.changeType) {
                subtitle = _react2.default.createElement(_TypeChanger2.default, { type: this.props.current.tags[0],
                    onCancel: function onCancel() {
                        return _this5.setState({ changeType: false });
                    },
                    onChange: function onChange(type) {
                        _this5.setState({ changeType: false });_this5.props.onChangeType(_this5.props.current, type);
                    } });
            } else {
            ...
            var toolbox = _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'li',
                        { onClick: function onClick() {
                                _this5.setState({ changeType: true });
                            } },
                        _react2.default.createElement(
                            'i',
            ...
            console.log('??????????', this.props.current, this.state.changeType);
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    console.log('Current Version:', '2.1.123');
...
var autoImport = exports.autoImport = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
        var name, exist, tempDir, dir, job, newDir, dirContent, id, unzipedDir, filesContent, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, file, tag, path, parent;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        // const slug = document.getElementById('root').
                        name = 'homebook.' + 'test' + '.zip';
        ...
        }, _callee, undefined, [[2, 8], [20, 25], [42, 76, 80, 88], [54, 60], [81,, 83, 87]]);
    }));
